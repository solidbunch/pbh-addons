...
/***/ "./addons/gutenberg/alert-gutenberg/src/js/block.js":
/*!**********************************************************!*\
  !*** ./addons/gutenberg/alert-gutenberg/src/js/block.js ***!
  \**********************************************************/
  ...
  */
   ...
   */
		wp.element.createElement(
			...
			wp.element.createElement(
				PanelBody,
				{ title: __('Attributes', 'page-builder-hub'), initialOpen: true },
				wp.element.createElement(SelectControl, {
					label: __('Type', 'page-builder-hub'),
					value: type,
					options: [{ label: __('Success', 'page-builder-hub'), value: 'success' }, { label: __('Info', 'page-builder-hub'), value: 'info' }, { label: __('Warning', 'page-builder-hub'), value: 'warning' }, { label: __('Danger', 'page-builder-hub'), value: 'danger' }],
   ...
   */
		wp.element.createElement(
			...
			wp.element.createElement('i', { className: 'pbh-icon' }),
			wp.element.createElement(RichText, {
				value: content,
				onChange: updateContent
			}),
			wp.element.createElement('a', { href: '#', className: 'pbh-alert-dismiss' })
		)];
	},
...
/***/ 0:
/*!****************************************************************!*\
  !*** multi ./addons/gutenberg/alert-gutenberg/src/js/block.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:/OSPanel/domains/hub.lc/wp-content/plugins/pbh-addons/addons/gutenberg/alert-gutenberg/src/js/block.js */"./addons/gutenberg/alert-gutenberg/src/js/block.js");


/***/ })

/******/ });
//# sourceMappingURL=block.build.min.js.map