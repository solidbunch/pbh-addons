...
/***/ "./addons/gutenberg/alert/src/js/block.js":
/*!************************************************!*\
  !*** ./addons/gutenberg/alert/src/js/block.js ***!
  \************************************************/
  ...
  */
   ...
   */
		wp.element.createElement(
			...
			wp.element.createElement(
				PanelBody,
				{ title: __('Attributes', 'pbh-blocks-alert'), initialOpen: true },
				wp.element.createElement(SelectControl, {
					label: __('Type', 'pbh-blocks-alert'),
					value: type,
					options: [{ label: __('Success', 'pbh-blocks-alert'), value: 'success' }, { label: __('Info', 'pbh-blocks-alert'), value: 'info' }, { label: __('Warning', 'pbh-blocks-alert'), value: 'warning' }, { label: __('Danger', 'pbh-blocks-alert'), value: 'danger' }],
...
/***/ 0:
/*!******************************************************!*\
  !*** multi ./addons/gutenberg/alert/src/js/block.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! F:/OSPanel/domains/_sb_/local/phub.loc/wp-content/plugins/pbh-addons/addons/gutenberg/alert/src/js/block.js */"./addons/gutenberg/alert/src/js/block.js");
